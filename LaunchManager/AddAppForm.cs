...
namespace LaunchManager
{
    public class AddAppForm : Form
    {
        ...
        public AddAppForm()
        {
            ...
            // Eventi dinamici
            rdoLM.CheckedChanged += (s, e) => { AggiornaUI(); ThemeManager.ApplyTheme(this); };
            rdoMSFS.CheckedChanged += (s, e) => { AggiornaUI(); ThemeManager.ApplyTheme(this); };

            chkStartMinimized.CheckedChanged += (s, e) =>
            {
                numStartMinimizedDelaySeconds.Enabled = chkStartMinimized.Checked;
                ThemeManager.ApplyTheme(this);
            };

            chkCloseWindow.CheckedChanged += (s, e) =>
            {
                numCloseWindowDelaySeconds.Enabled = chkCloseWindow.Checked;
                ThemeManager.ApplyTheme(this);
            };
        ...
        private void InitializeComponent()
        {
            ...
            {
                chkStartMinimized, numStartMinimizedDelaySeconds, lblStartMinimizedDelaySeconds,
                chkCloseWindow, numCloseWindowDelaySeconds, lblCloseWindowDelaySeconds,
                chkCloseMSFS
            });
            ...
            rdoLM = new RadioButton { Text = "LM", Location = new Point(20, 25), AutoSize = true };
            rdoMSFS = new RadioButton { Text = "MSFS", Location = new Point(200, 25), AutoSize = true, Checked = true };
