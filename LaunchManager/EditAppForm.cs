...
namespace LaunchManager
{
    public class EditAppForm : Form
    {
        ...
        public NumericUpDown numDelaySeconds;
        public NumericUpDown numStartMinimizedDelaySeconds;
        public NumericUpDown numCloseWindowDelaySeconds;

        public CheckBox chkStartMinimized;
        public CheckBox chkCloseWindow;
        public CheckBox chkCloseMSFS;
        ...
        private Label lblStartMinimizedDelaySeconds;
        private Label lblCloseWindowDelaySeconds;
        private Label lblDelaySeconds;
        ...
        private void InitializeComponent()
        {
            ...
            btnBrowse.Click += (s, e) =>
            {
                ...
                {
                    dlg.Filter =
                        "Programs (*.exe;*.lnk)|*.exe;*.lnk|All files (*.*)|*.*";
